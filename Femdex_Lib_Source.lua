...
if _G.Femdex_Loaded and _G.Femdex then
    _G.Femdex:Destroy()
end

-- Set Globals --
_G.Femdex_Loaded = true
_G.Femdex = nil
...
_G.Femdex = Femdex.ScreenGui
for i,v in pairs({Name = "Template", Debug = false}) do
    if Femdex.Settings[i] == nil then
        Femdex.Settings[i] = v
    end
end

-- Intro --
function Femdex.LoadingScreen()
    coroutine.wrap(function()
        local LoadingScreen = Utility.new("Frame", {
            Name = "LoadingScreen",
            Parent = Femdex.ScreenGui,
        ...
        Utility.Wait(2.5)
        Services.ContentProvider:PreloadAsync({Femdex.ScreenGui})
        Utility.Wait(0.25)
...
local function CreateOptions(Frame)
    ...
    function Options.Button(Title, ButtonText, Callback)
        ...
        Container.Button.MouseButton1Down:Connect(function()
            ...
            assert(Femdex.Settings.Debug == false or Success, Error)
        end)
    ...
    function Options.Switch(Title, Callback)
        ...
        local Tweens = {
            [true] = {
                Utility.Tween(Container.Switch, TweenInfo.new(0.5), {BackgroundColor3 = Femdex.ColorScheme.Primary}),
                Utility.Tween(Container.Switch.Circle, TweenInfo.new(0.25), {AnchorPoint = Vector2.new(1, 0.5), Position = UDim2.new(1, 0, 0.5, 0)})
            };

            [false] = {
                Utility.Tween(Container.Switch, TweenInfo.new(0.5), {BackgroundColor3 = Color3.fromRGB(255, 182, 193)}),
    ...
    function Options.Toggle(Title, Callback)
        ...
        local Tweens = {
            [true] = {
                ...
                Utility.Tween(Container.Toggle, TweenInfo.new(0.5), {ImageColor3 = Color3.fromRGB(255, 182, 193)})
            };
            [false] = {
        ...
        local Container = Utility.new("ImageButton", {
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("TextBox", {
                    ...
                    Size = UDim2.new(1, 0, 1, 0),
                    Font = Enum.Font.Gotham,
                    PlaceholderColor3 = Color3.fromRGB(255, 182, 193),
        ...
        local Container = Utility.new("ImageButton", {
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("ImageLabel", {
                    ...
                    Image = "rbxassetid://5028857472",
                    ImageColor3 = Femdex.ColorScheme.Primary,
                    ScaleType = Enum.ScaleType.Slice,
                    SliceCenter = Rect.new(2, 2, 298, 298)
                }, {
                    Utility.new("Frame", {
...
function Femdex.new(Name, Header, Icon)
            ...
            Utility.new("ImageLabel", {
                ...
                Utility.new("Frame", {
                    ...
                    Utility.new("TextLabel", {
                        ...
                        Text = Name and tostring(Name) or "Femdex",
                        TextColor3 = Color3.fromRGB(255, 182, 193),
                        TextScaled = true,
                        TextWrapped = true,
                        TextXAlignment = Enum.TextXAlignment.Left
    ...
    -- Window --
    local Window = {
        Title = Name and tostring(Name) or "Femdex";
    ...
    function Window.Tab(Title, Icon)
        ...
        local TabButton = Utility.new("Frame", {
            Name = "Button",
            Parent = Main.SideBar,
            BackgroundColor3 = Femdex.ColorScheme.Primary,
            BackgroundTransparency = 1,
            BorderSizePixel = 0,
        ...
        function Tab.Folder(Title, Description)
            ...
            local Tweens = {
                [true] = {
                    ...
                    Utility.Tween(Base.Title, TweenInfo.new(0.5), {TextTransparency = 0, TextColor3 = Femdex.ColorScheme.Primary}),
                    Utility.Tween(Base.Icon, TweenInfo.new(0.5), {ImageTransparency = 0, ImageColor3 = Femdex.ColorScheme.Primary}),
                };
                [false] = {
                    function()
                        Utility.Wait(0.1)
                    ...
                    Utility.Tween(Base.Title, TweenInfo.new(0.5), {TextTransparency = 0.3, TextColor3 = Color3.fromRGB(255, 182, 193)}),
                    Utility.Tween(Base.Icon, TweenInfo.new(0.5), {ImageTransparency = 0.3, ImageColor3 = Color3.fromRGB(255, 182, 193)})
                };
            }
        ...
        function Tab.Cheat(Title, Description, Callback)
            ...
            local SwitchTweens = {
                [true] = {
                    Utility.Tween(Base.Switch, TweenInfo.new(0.5), {BackgroundColor3 = Femdex.ColorScheme.Primary}),
                    Utility.Tween(Base.Switch.Circle, TweenInfo.new(0.25), {AnchorPoint = Vector2.new(1, 0.5), Position = UDim2.new(1, 0, 0.5, 0)})
                };

                [false] = {
                    Utility.Tween(Base.Switch, TweenInfo.new(0.5), {BackgroundColor3 = Color3.fromRGB(255, 182, 193)}),
    ...
    return setmetatable(Window, {__newindex = function(Self, Index, Value)
        if Index == "Title" then
            Main.SideBar.Info.Title.Text = Value and tostring(Value) or "Femdex"
